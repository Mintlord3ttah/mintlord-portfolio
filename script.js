...
window.addEventListener('orientationchange', function() {
    const screenType = window.screen.orientation
    let angle = screenType.angle
    if (screenType !== "landscape-primary") {
        angle = 90
...
function displayDiceRoll(rand, PLAYING){
...
function HOLD() {
    ...
    if(Number(totalScore.textContent) >= 30){
        ...
        PLAYING = false;
        displayDiceRoll(getRand, PLAYING)
    }
